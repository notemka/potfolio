	...
	<ul class="form-list">
		...
		<li class="form-item">
			<div class="name-box clearfix">
				...
				<input type="text" name="name" class="field name-field" data-validation = "name" placeholder="Как к вам обращаться">
			</div>
			<div class="email-box">
				<label for="email" class="label-for-input">Email</label>
				<input type="email" name="email" class="field email-field" data-validation = "email" placeholder="Куда мне писать">
			</div>
		</li>
		<li class="form-item">
			<label for="message" class="label-for-input">Сообщение</label>
			<textarea name="message" id="" class="field message-field" data-validation = "msg" placeholder="Кратко в чем суть"></textarea>
		</li>
		<li class="form-item">
